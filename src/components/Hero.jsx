...
const Hero = () => {
  return (
      ...
      <section className="grid lg:grid-cols-2 lg:h-[680px] min-h-[600px] lg:gap-x-[5rem]">
        <div id="avatar" className="lg:max-w-[300px] max-w-[200px] place-self-center lg:place-self-end lg:self-center"><img className="object-cover" src={avatar}></img></div>
        <div id="introduction" className="text-center lg:text-left place-self-center lg:place-self-start lg:self-center">
